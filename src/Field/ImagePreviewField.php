...
class ImagePreviewField
{
    ...
    public static function new(string $propertyName, $label = null): self
    {
        return (new self())
            ...
            // To use ImageField configurator
            ->setFieldFqcn(\EasyCorp\Bundle\EasyAdminBundle\Field\ImageField::class);
    }

    public function setBasePath(string $path): self
    {
        $this->setCustomOption(self::OPTION_BASE_PATH, $path);
        $this->setFormTypeOption('attr.data-eaf-base-path', $path);
    ...
    public function setUploadDir(string $uploadDirPath): self
    {
        ...
        $this->setFormTypeOption('attr.data-eaf-upload-dir-path', $uploadDirPath);
